				...
				<!-- Nav -->
					<nav id="nav">
						<ul class="links">
							...
							<li class="active"><a href="commande.php">Commander sa place</a></li>
						</ul>
						<ul class="icons">
				...
				<!-- Main -->
					<div id="main">
						<div style="min-height: 684px;">
							<img src="images/chargement.gif" style="transform: translateX(-50%);left: 50%;position: absolute;z-index: -1;">
							<a title="Logiciel billetterie en ligne" href="https://weezevent.com/?c=sys_widget" class="weezevent-widget-integration" target="_blank" data-src="https://www.weezevent.com/widget_billeterie.php?id_evenement=573815&lg_billetterie=1&code=71620&width_auto=1&color_primary=d4c37c" data-width="650" data-height="600" data-id="573815" data-resize="1" data-width_auto="1" data-noscroll="0" data-nopb="0" >
